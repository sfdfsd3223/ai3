...
CONTENT_BY_LABEL: dict[str, dict[str, list[str]]] = {
     ...
     labels[0]: {
       "texts": ["치킨는 맛있다다", "치킨의 맛 포인트는 바삭한 튀김옷과 촉 juicy한 속살이 대비되며, 양념·소금 등 다양한 시즈닝이 더해져 풍부한 풍미를 만드는 데 있습니다", "치킨은 한국의 바삭한 양념치킨, 미국의 시즈닝 강한 버팔로·프라이드, 일본의 간장 가라아게처럼 나라별로 조리 방식과 풍미가 크게 다릅니다.
중국의 매운 라조지, 중동의 향신료 치킨, 유럽의 허브 로스트처럼 각 지역 재료와 조리법이 더해져 독특한 스타일을 형성합니다"],

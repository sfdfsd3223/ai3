...
CONTENT_BY_LABEL: dict[str, dict[str, list[str]]] = {
     ...
     labels[1]: {
       "texts": ["파스타는 맛있다", "파스타의 맛 포인트는 면의 탄탄한 알덴테 식감과 소스(토마토·크림·오일 등)가 면에 균형 있게 코팅되며 재료의 풍미가 조화롭게 어우러지는 데 있습니다", "파스타는 이탈리아에서 지역별로 다양하게 발전했으며, 북부는 크림·치즈·버터 소스, 남부는 토마토·올리브유 중심 소스를 많이 사용합니다.미국은 넉넉한 소스와 큰 재료, 일본은 간장·해산물 기반으로 변형하는 등 각 나라 입맛에 맞춘 스타일이 특징입니다"],
